...
- Crie uma branch por feature: `git checkout -b feat/minha-melhora`
- Faça commits pequenos e claros
- Abra PR com descrição das mudanças

---

Quer que eu gere um README global na raiz do repositório com badges, instruções de deploy e comandos adicionais (Windows/Linux)? Posso também incluir exemplos visuais em HTML se desejar.

_Arquivo gerado automaticamente — atualizado em novembro de 2025_
